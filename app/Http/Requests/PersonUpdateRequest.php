...
class PersonUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'cpf' => ['required', 'string', new CpfBr(), Rule::unique('people', 'cpf')->ignore($personId)],
            'data_nascimento' => ['required', 'date', 'before:today'],
            'email' => ['required', 'string', 'lowercase', 'email:rfc,dns', 'max:255', Rule::unique('people', 'email')->ignore($personId)],
