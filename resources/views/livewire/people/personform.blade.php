<div class="space-y-6">
    ...
    <form wire:submit.prevent="create" class="rounded-lg bg-white p-6 shadow-sm">
        ...
        <div class="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-end">
            ...
            <button
                type="submit"
                class="inline-flex items-center justify-center rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-black shadow-sm transition hover:bg-indigo-700"
            >
